...
import { Package, User, Phone, MapPin, Award, Shield, AlertTriangle, Loader2, ArrowLeft, Heart } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="max-w-3xl mx-auto px-4 -mt-8 space-y-6">
        {/* Reward Card / Special Instructions */}
        {isProduct ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Item Info / Emergency Info */}
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            <h3 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4 flex items-center">
              {isProduct ? <Package className="h-4 w-4 mr-2" /> : <Heart className="h-4 w-4 mr-2" />}
          ...
          {/* Owner Details / Emergency Contact */}
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            <h3 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4 flex items-center">
              <User className="h-4 w-4 mr-2" /> {isProduct ? 'Owner Details' : 'Emergency Contact'}
            </h3>
